...
*************************************************************************/
void SimpletronSimulator::resetComputer(Simpletron &program)
{
	accumulator = 0;
...
*************************************************************************/
void SimpletronSimulator::dump(Simpletron &program)
{
	cout << "REGISTERS:" << endl;
...
*************************************************************************/
void SimpletronSimulator::loadTest1(Simpletron &program) //Compute sum of 2 numbers
{
...
void SimpletronSimulator::loadTest2(Simpletron &program) //Compute subtraction of 2 numbers
{
	cout << "*** Simpletron Program Instructions ***" << endl;
	cout << " 00 ? +10007" << endl;
	program.store(0, 10007);
...
void SimpletronSimulator::loadTest3(Simpletron &program) //Compute multiplication of 2 numbers
{
	cout << "*** Simpletron Program Instructions ***" << endl;
	cout << " 00 ? +10007" << endl;
	program.store(0, 10007);
...
void SimpletronSimulator::loadTest4(Simpletron &program) //Compute division of 2 numbers
{
	cout << "*** Simpletron Program Instructions ***" << endl;
	cout << " 00 ? +10007" << endl;
	program.store(0, 10007);
